...
def decide_image_input_mode(
    ...
    # auto
    # Copilot ACP transport is text-only JSON-RPC — it cannot carry
    # image_url parts even when the underlying model supports vision.
    # Force the text pipeline so _enrich_message_with_vision() runs
    # and the ACP client only ever receives text descriptions.
